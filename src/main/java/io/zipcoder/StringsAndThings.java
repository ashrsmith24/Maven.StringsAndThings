...
public class StringsAndThings {
    ...
    public Boolean gIsHappy(String input) {
        int counterg = 0;
        String[] letterg = input.split("");
        for (int i = 0; i < letterg.length; i++) {
//            if (letterg[i].contains("g")) {
//                counterg++;
//                return true;
//            } else if (!letterg[i].contains("g")) {
//                return false;
//            }
//
//            return false;
    ...
    public Integer countTriple(String input) {
        // return the number if char appears three times in a row.
        int counter = 0;
